    ...
    <div class="flex w-full max-w-6xl bg-white rounded-[40px] shadow-2xl overflow-hidden min-h-[650px]">
      ...
      <div class="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white">
        <div class="w-full max-w-[400px] mx-auto">
          ...
          <!-- Register Link -->
          <p class="text-center text-[11px] text-gray-400 mt-3 font-medium uppercase tracking-wider">
            Nhớ mật khẩu rồi?
            <router-link to="/khach-hang/dang-nhap" class="text-indigo-900 font-black hover:underline ml-1">
              Đăng nhập ngay
            </router-link>
          </p>
        </div>
