<template>
  <div class="min-h-screen bg-[#f0f4f8] font-['Inter']">
    <!-- Hero Banner -->
    <div
      class="relative h-40 bg-gradient-to-r from-[#1e3a8a] via-[#1d4ed8] to-[#0ea5e9] overflow-hidden"
    >
      <div
      ...
      ></div>
      <div
        class="absolute bottom-0 left-0 right-0 h-16 bg-[#f0f4f8]"
    ...
    <div class="container mx-auto max-w-6xl px-4 -mt-16 pb-12">
      <!-- Profile Header Card -->
      <div
        class="bg-white rounded-3xl shadow-xl p-6 mb-6 flex flex-col sm:flex-row items-center sm:items-end gap-5"
      >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm p-6">
            <div class="flex items-center gap-3 mb-6">
              <div
                class="w-9 h-9 bg-amber-100 rounded-xl flex items-center justify-center"
              >
                <svg
            ...
            <div class="space-y-4">
              ...
              >
                <span
                  v-if="changingPwd"
                  class="w-4 h-4 border-2 border-amber-400/30 border-t-amber-500 rounded-full animate-spin"
                ></span>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <span
                  class="text-xs font-black bg-red-500 text-white rounded-full px-2 py-0.5"
                  >{{ favCount }}</span
                >
              </router-link>
              <router-link
          ...
          <!-- Upgrade Banner -->
          <div
            class="relative rounded-2xl overflow-hidden p-6 text-white"
          ...
          >
            ...
            <router-link
              to="/khach-hang/nang-cap-moi-gioi"
          ...
          <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            >
              <img
                :src="
                  f.bat_dong_san?.anh_dai_dien_url ||
