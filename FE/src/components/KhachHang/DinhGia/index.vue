    ...
    <div class="hero-section">
      <div class="container text-center">
        ...
        <p class="lead text-white-50 mx-auto" style="max-width: 600px;">
          Sử dụng trí tuệ nhân tạo để phân tích hàng ngàn dữ liệu thị trường và cung cấp cho bạn khoảng giá trị chính
          xác nhất của bất động sản.
        </p>
      </div>
    </div>
      ...
      <div class="row justify-content-center">
            ...
            <div class="card-body p-4">
              ...
              <form @submit.prevent="handlePredict">
                ...
                <div class="mb-4">
                  ...
                  <input v-model="form.dien_tich" type="number" class="form-control" placeholder="VD: 100" min="1"
                    max="100000" step="any" required />
                </div>

                <button type="submit" style="background: #0a0e27;" class="btn text-white w-100 btn-predict"
        ...
        <div class="col-lg-7 mb-4">
          <div class="card shadow-sm border-0 h-100 result-card">
            <!-- Trạng thái chờ -->
            <div v-if="!result && !isPredicting"
              class="card-body p-5 d-flex flex-column align-items-center justify-content-center text-center text-muted">
              <img src="https://cdn-icons-png.flaticon.com/512/3233/3233974.png" alt="AI Robot" width="120"
                class="mb-4 opacity-50" />
              <h5 class="fw-bold">AI Đang chờ thông tin</h5>
              <p>Hãy nhập đầy đủ thông tin bên trái để nhận kết quả định giá dựa trên AI phân tích dữ liệu thị trường.
              </p>
            </div>
            ...
            <div v-else-if="isPredicting"
              ...
              <p class="text-muted small">AI đang phân tích hàng ngàn mẫu bất động sản tương đồng tại khu vực bạn chọn
                để đưa ra mức giá tốt nhất.</p>
            ...
            <div v-else-if="result" class="card-body p-0">
              <div class="result-header p-4 text-center text-white rounded-top"
                style="background: linear-gradient(135deg, #1e40af, #3b82f6);">
                <h6 class="text-uppercase mb-2" style="letter-spacing: 1px;"><i
                    class="bi bi-check-circle-fill text-success me-2"></i>Định giá hoàn tất</h6>
                <h3 class="fw-bold mb-0 text-warning">{{ formatCurrency(result.gia_du_doan_min) }} - {{
                  formatCurrency(result.gia_du_doan_max) }}</h3>
              ...
              <div class="p-4">
                <div class="row text-center mb-4 g-3">
                  <div class="col-6">
                    <div class="p-3 bg-light rounded">
                      ...
                      <h5 class="fw-bold text-primary mb-0">{{ formatCurrency(result.don_gia) }} <span
                          class="fs-6 fw-normal">/m²</span></h5>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="p-3 bg-light rounded">
                ...
                <div class="alert alert-info border-0 bg-opacity-10 d-flex gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p class="mb-0 small text-muted">Kết quả được tính toán dựa trên thuật toán AI phân tích <b>{{
                      result.so_mau_tham_khao }} mẫu BĐS</b> trên hệ thống. Đây chỉ là khoảng giá trị mang tính chất
                      tham khảo, thực tế có thể thay đổi tùy thuộc vào vị trí mặt tiền, nội thất và tình trạng thực tế
                      của BĐS.</p>
                  </div>
                </div>

                <!-- Bất động sản tham khảo -->
                <div v-if="result.danh_sach_tham_khao && result.danh_sach_tham_khao.length > 0"
                  class="reference-properties mt-4">
                  <h6 class="fw-bold mb-3 d-flex align-items-center">
                    <i class="bi bi-houses-fill text-primary me-2"></i> Bất động sản tham khảo
                  </h6>
                  <div class="list-group">
                    <router-link v-for="bds in result.danh_sach_tham_khao" :key="bds.id"
                      ...
                      <img :src="bds.anh_dai_dien_url || 'https://placehold.co/100x100?text=No+Image'"
                        class="rounded me-3 object-fit-cover" width="60" height="60" alt="Ảnh BĐS">
                      <div class="flex-grow-1 min-w-0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-1">
                          ...
                          <span class="text-muted small"><i class="bi bi-arrows-fullscreen me-1"></i>{{ bds.dien_tich }}
                            m²</span>
