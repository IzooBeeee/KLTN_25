  ...
  <div class="mg-dashboard">
    ...
    <div class="mg-main">
      ...
      <div class="mg-col-left">
        ...
        <div class="mg-card">
          <div class="mg-card__head">
            <h3 class="mg-card__title"><i class="fa-solid fa-chart-column" style="color:#3b82f6"></i> Bài đăng 6 tháng
              qua</h3>
          </div>
        ...
        <div class="mg-card">
          <div class="mg-card__head">
            ...
            <router-link to="/moi-gioi/quan-ly-bat-dong-san" class="mg-card__link">Xem tất cả →</router-link>
          </div>
      ...
      <div class="mg-col-right">
        <!-- Package Card -->
        <div class="mg-card mg-card--plan"
          :class="{ 'expiring': plan.days_until_expiry !== null && plan.days_until_expiry <= 7 }">
          <div class="mg-card__head">
          ...
          <div v-if="plan.current" class="mg-plan">
            ...
            <div class="mg-plan__price">{{ formatPrice(plan.current.gia) }}<span>/{{ plan.current.so_ngay }} ngày</span>
            </div>
            <div class="mg-plan__features">
              <div class="mg-plan__feat"><i class="fa-solid fa-check"></i> {{ plan.current.so_luong_tin }} tin đăng
              </div>
              <div class="mg-plan__feat"><i class="fa-solid fa-check"></i> {{ stats.credits_remaining }} tin còn lại
              </div>
            </div>
            <div class="mg-plan__expiry"
              :class="{ warning: plan.days_until_expiry !== null && plan.days_until_expiry <= 7 }">
              <i class="fa-regular fa-calendar"></i>
              Hết hạn: {{ plan.expiry_date }}
              <span v-if="plan.days_until_expiry !== null" class="days-left">
                ({{ plan.days_until_expiry > 0 ? `còn ${Math.ceil(plan.days_until_expiry)} ngày` : 'đã hết hạn' }})
              </span>
            </div>
        ...
        <div class="mg-card">
          ...
          <router-link to="/moi-gioi/lich-su-mua-tin" class="mg-card__link" style="display:block;margin-top:1rem">
        ...
        <div class="mg-card">
          ...
          <div class="mg-quick-actions">
            <router-link to="/moi-gioi/dang-tin" class="mg-quick-btn">
              <i class="fa-solid fa-plus"></i> Đăng tin mới
            </router-link>
            <router-link to="/moi-gioi/quan-ly-bat-dong-san" class="mg-quick-btn secondary">
              <i class="fa-solid fa-list"></i> Quản lý BĐS
            </router-link>
            <router-link to="/moi-gioi/quan-ly-khach-hang" class="mg-quick-btn secondary">
...
.mg-hero {
  ...
  position: relative;
  overflow: hidden;
  background: linear-gradient(135deg, #0e1412 0%, #168a45 48%, #4afaa2 100%);
  padding: 2.5rem 2rem;
  color: #fff;
  box-shadow: 0 24px 64px -12px rgba(16, 185, 129, 0.35);
}
...
.mg-plan__expiry.warning {
  color: #ef4444;
  font-weight: 600;
}

.mg-plan__expiry .days-left {
  font-weight: 700;
}
...
.mg-bds__status.approved {
  background: #dcfce7;
  color: #166534;
}

.mg-bds__status.pending {
  background: #fef3c7;
  color: #92400e;
}
