<template>
  <div class="mg-lich-hen">
    ...
    <div class="mg-lh-tabs">
      <button v-for="tab in tabs" :key="tab.value" class="mg-lh-tab" :class="{ active: filter === tab.value }"
...
.mg-lh-card__status.warning {
  background: #fef3c7;
  color: #92400e;
}

.mg-lh-card__status.info {
  background: #dbeafe;
  color: #059669;
}

.mg-lh-card__status.success {
  background: #d1fae5;
  color: #065f46;
}
